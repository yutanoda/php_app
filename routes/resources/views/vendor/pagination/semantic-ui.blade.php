@if ($paginator->hasPages())
        {{-- Previous Page Link --}}
            ...
            <li class="page-number color_b1n"><a class="icon item disabled color_t1n" href="{{ $paginator->url(1) }}" aria-label="@lang('pagination.previous')">|&lt;</a></li>
        ...
        {{-- Next Page Link --}}
            ...
            <li class="page-number color_b1n"><a class="icon item disabled color_t1n" href="{{ $paginator->url($paginator->lastPage()) }}" aria-label="@lang('pagination.next')">&gt;|</a></li>
@endif
