	...
	<header>
		...
		<nav>
			<ul>
				...
				<li><strong><span>個別報告書</span></strong></li>
		...
		<div>
			<section id="search">
				<form>
					...
					<button class="new"><span>新規報告作成</span></button>
				</form>
			</section>
			<section id="result">
				...
				<table>
					...
					<tbody>
						<tr>
							<td class="no" data-th="No.">00025<a href="individual_report.html">詳細</a></td>
							...
							<td class="content">
								<article>
									...
									<p>橘(C280)1年…小論は学研。今年は1回書き切りだったので来年はリピートを予定、点数表記が良いので第一も候補と。他校実績例を開かれ2回の黎明・郡山、会津、志望理由指導を採用した安積の例を紹介する。特化データ型にも興味有。</p>
									<p>他校実績例を開かれ2回の黎明・郡山、会津、志望理由指導を採用した安積の例を紹介する。特化データ型にも興味有。</p>
								</article>
							</td>
							<td class="comment">
								<article>
